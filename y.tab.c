...
{
  "$end", "error", "$undefined", "NUMBER_T", "TEXT_T", "MAIN", "END",
  "PRINT", "texto", "TEXT_C", "EQUALS", "GT", "GET", "LT", "LET",
  "EQUALSCMP", "NTEQUAL", "PLUS", "MINUS", "MUL", "DIV", "MOD", "OR",
  "AND", "NOT", "$accept", "program", "statement", "PRINT_F", "EXPRESSION",
  "TERM", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 56 "sintaxis.y" /* yacc.c:1646  */
    {
			printf("%s", strcat("#include <stdio.h>\n int main(void)",(yyvsp[0].node)->string);
			}
#line 1276 "y.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 59 "sintaxis.y" /* yacc.c:1646  */
    { 
			(yyval.node) = newNode(TYPE_TEXT, strcatN(3, "{\n",(yyvsp[-1].node)->string,"}"));
			}
#line 1284 "y.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 62 "sintaxis.y" /* yacc.c:1646  */
    {
			(yyval.node) = newNode(TYPE_TEXT, ";");
			}
#line 1292 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 66 "sintaxis.y" /* yacc.c:1646  */
    {
			if((yyvsp[0].node)->type == TYPE_TEXT)
				(yyval.node) = newNode(TYPE_TEXT, strcatN(3, "printf(\"%s\"", (yyvsp[0].node)->string , ");\n" );
			}
#line 1301 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 71 "sintaxis.y" /* yacc.c:1646  */
    {(yyval.node) = (yyvsp[0].node);}
#line 1307 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 73 "sintaxis.y" /* yacc.c:1646  */
    {(yyval.node) = newNode(TYPE_TEXT, (yyvsp[0].node)->string);}
...
#line 74 "sintaxis.y" /* yacc.c:1906  */
